...
class DataTransformation:
    ...
    def initiate_data_transformation(self):
        try:
            ...
            save_np_array(file_path=self.data_transformation_config.transformed_train_file_path,array=train_arr)
            save_np_array(file_path=self.data_transformation_config.transformed_test_file_path,array=test_arr)

            save_object(file_path=self.data_transformation_config.transformed_object_file_path,file_obj=preprocessor_obj)
